            ...
            <div class="than4" style="background: white">
                <div class="row">
                    <div class="col-md-12 col-xs-12">
                        <div class="title5">
                            <h3 class="title5">Khảo Sát Giảng Viên</h3>
                        </div>                
                    </div>
                    @if(count($errors)>0)
                    ...
                    @endif
                    <form action="prodview3" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12 col-xs-12 " style="margin-top:25px">
                                <div class="row">
                                        ...
                                        <label  style="margin-left:70px;margin-top: 7px;" for="inputState">Bộ Môn Đào Tạo </label><br>    
                                        <select style="width: 300px;margin-left: 15px;"class="subject" name="id_subject"> 
                                        </select>
                                </div>
                        </div>
                        <div class="col-md-12 col-xs-12"  >
