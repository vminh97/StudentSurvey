            ...
            <div class="col-md-12">
                <div class="row t4">
                    <div class="col-md-12 "   style="border: 1px solid #cacaca;margin-left: 0px;"   >
                        <div class="row ">
                            <div class="col-md-12">
                                <h2 class="l6"><i class="fa fa-briefcase"> Danh Sách Khảo Sát Cựu Sinh Viên</i></h2>
                            </div>
                            <div class="col-md-12">
                                @foreach ($kssv as $kss)
                                        ...
                                        <div class="t3">
                                            <div class="row ">
                                                ...
                                                <div class="col-md-8 t2 ">    
                                                    <b>{{$kss->NameTheme}}</b><br>
                                                <a class="n4" href="/prodview/{{$kss->id}} ">Thông báo về khảo sát {{$kss->NameSurvey}}</a>                               
                                                </div> 
                                                <div style="margin-top:-15px">
                                                    <img style="margin-left: 730px" src="isset/fronted/image/user.png" alt="">
                                                    <b style="margin-left: 3px;">{{$kss->type}} </b>       
                                                </div>                                    
                                            </div> 
                                        </div>  
                                    </div>
