            ...
            <div class="than4" style="background: white">
                <div class="row">
                    <div class="col-md-12 col-xs-12">
                        <div class="title5">
                            <h3 class="title5">Khảo Sát Cựu Sinh Viên</h3>
                        </div> 
                        @if(count($errors)>0)
                    ...
                    <form action="prodview" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="title6">
                                <div class="row">
                                    <div class="col-md-5 offset-1 col-xs-12 ">
                                        ...
                                        <span>
                                            <input  class="form-control" name="NameAlummi"   > 
                                        </span>
                                    </div>
                            ...
                            <div class="title6">
                                <div class="row">
                                    <div class="col-md-2 offset-1 col-xs-12 ">
                                        <label class="v1" for="inputState">Khóa Học</label>
                                        <span>
                            ...
                            <div class="row">
                                <div class="col-md-4 offset-5 col-xs-12 ">                        
                                    <div class="form-group" >
                                        <label style="margin-left:100px;margin-top: 7px;"  for="inputState">Chọn Đợt Khảo Sát</label>
                                        <select style="width: 250px;
                                        height: 40px;" name="survey" id="survey " >
