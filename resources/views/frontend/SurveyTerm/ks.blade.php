...
<div class="ch">
    ...
    <div class="than3">
            ...
            <div class="row">
                <div class="col-md-12 than33">
                    <div class="alert alert-secondary" role="alert" style="background-color: #007bff;">
                        <h3 class="m1" >Khảo Sát Sinh Viên Học Phần</h3>     
                    </div>
                </div>
                <div class="col-md-12 a" style="margin-top: 30px;">
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <div class="row">
                                <div class="col-md-6 ">
                                    <label class="kl" for="inputState">Người Khảo sát</label>
                                </div>
                                <div class="col-md-6 ">
        ...
        <div class="bch">
            <div class="container">
                <div class="bch1">
                <form action="/postQuestionTerm/{{$idUser}}" method="POST" enctype="multipart/form-data">
